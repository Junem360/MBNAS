...
DEFINE_string("output_dir", "./outputs/evaluate_x2_result", "path of result")
DEFINE_string("checkpoint", "./outputs/x2_train/model.ckpt-893000", "path of checkpoint file")
...
DEFINE_float("child_lr_dec_rate", 0.8, "")
