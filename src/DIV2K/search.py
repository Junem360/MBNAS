...
DEFINE_string("output_dir", "./outputs/x2_search", "path of result")
...
def train():
    ...
    with g.as_default():
        ...
        with tf.train.SingularMonitoredSession(
            ...
            while True:
                x_train, y_train = get_random_batch_early(labels["train"], FLAGS.batch_size,
                    ...
                    if (FLAGS.controller_training and
                        ...
                        for ct_step in range(FLAGS.controller_train_steps):
                            ...
                            for _ in range(num_valid_batches):
                                x_valid_rl, y_valid_rl = get_random_batch_early(labels["valid"],
                        ...
                        for _ in range(5):
                            ...
                            for _ in range(num_valid_batches):
                                x_valid, y_valid, texture_valid = get_random_batch_early(labels["valid"],
                                                                                            FLAGS.eval_batch_size,
                                                                                            FLAGS.eval_patch_size * FLAGS.child_upsample_size,
                                                                                            FLAGS.child_upsample_size)
